 ...
 * </ol>
 */
class TestFuzzConstructorFiltreLlibre {
    ...
    @FunctionalInterface
    private interface ProveidorDades<T> { T get(FuzzedDataProvider d); }

    private static <T> T consumeNullable(FuzzedDataProvider data, ProveidorDades<T> s) {
