...
class LlibreFieldBindingsTest {
    ...
    void forInsertInvalidDate() {
        ...
        Object[] v = LlibreFieldBindings.forInsert(l);
        assertThat(v[15]).isInstanceOf(LlibreFieldBindings.Null.class);
    }
    ...
    void bindNull() throws SQLException {
    ...
    void bindNullMarker() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
        LlibreFieldBindings.bind(ps, 1, new LlibreFieldBindings.Null(Types.DATE));
        verify(ps).setNull(1, Types.DATE);
    }

    @Test
    @DisplayName("bind: Integer → setInt")
    void bindInteger() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
    ...
    void bindLong() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
    ...
    void bindDouble() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
    ...
    void bindBoolean() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
    ...
    void bindSqlDate() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
    ...
    void bindBytes() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
        byte[] data = {1, 2, 3};
    ...
    void bindStringFallback() throws SQLException {
        PreparedStatement ps = mock(PreparedStatement.class);
