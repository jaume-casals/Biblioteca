...
public class QuantADialog extends JDialog {

	private static final String SOURCE_URL = "https://github.com/jaume-casals/Biblioteca";

	private static String getVersion() {
		try (var in = QuantADialog.class.getResourceAsStream("/version.properties")) {
			if (in != null) {
	...
	public QuantADialog(Frame parent) {
	...
	private static String carregarLicense() {
		try (var in = QuantADialog.class.getResourceAsStream("/LICENSE")) {
