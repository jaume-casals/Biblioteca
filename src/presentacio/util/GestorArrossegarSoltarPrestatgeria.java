...
import presentacio.panells.PanellBarraEsquerra;


/** Adjunta les destinacions d'arrossegar a prestatgeria; manté la lògica de DnD fora de {@link PanellBarraEsquerra}. */
public final class GestorArrossegarSoltarPrestatgeria {

    private GestorArrossegarSoltarPrestatgeria() {}

    public static void attach(JButton shelfBtn, int shelfId, BiConsumer<Integer, List<Long>> onDrop) {
