...
public final class ConfiguracioImagesSection {
    private ConfiguracioImagesSection() {}
    ...
    public static void reloadFromConfig(JPanel root) {
        javax.swing.JComponent jc = ConfigSections.findById(root, "txtImgDir");
        if (jc instanceof JTextField) ((JTextField) jc).setText(Config.getDefaultImgDir());
    }
}
