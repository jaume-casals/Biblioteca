package fuzz.herramienta.io.csv;
...
class TestFuzzUtilitatsCsv {
    ...
    void trailingNewlineDoesNotChangeFieldCount() {
        String s = "a,b,c";
        assertThat(UtilitatsCsv.analitzarLine(s)).hasSameSizeAs(UtilitatsCsv.analitzarLine(s + "\n"));
    }
}
