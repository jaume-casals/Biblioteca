...
public class MostrarBibliotecaControl {
	...
	public MostrarBibliotecaControl(MostrarBibliotecaPanel vista, ArrayList<Llibre> biblio, String header[]) {
		...
		b.add(new Llibre(1, "asdfasdf", "2", 1, "sadfasdfasd", 2.3, 2.3, true));
		b.add(new Llibre(2, "dasdfasdfsdfadf2", "3", 2, "sadfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(4, "dasdfasdfsdfadf1", "5", 4, "asdfasdfasdfas", 2.3, 2.3, true));
		b.add(new Llibre(5, "dasdfasdfsdfadf", "6", 5, "dfasdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf8", "7", 6, "asdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf7", "7", 6, "dfasdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf6", "8", 6, "asdfasdfasdfas", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf5", "9", 6, "dfasdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf4", "0", 6, "asdfasdfasdfasd", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf3", "'", 6, "asdfasdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf2", "8", 6, "asdfasdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(6, "dasdfasdf1", "7", 6, "asdfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(1, "asdfasdf", "2", 1, "sadfasdfasd", 2.3, 2.3, true));
		b.add(new Llibre(2, "dasdfasdfsdfadf2", "3", 2, "sadfasdfasdf", 2.3, 2.3, true));
		b.add(new Llibre(4, "dasdfasdfsdfadf1", "5", 4, "asdfasdfasdfas", 2.3, 2.3, true));
		b.add(new Llibre(5, "dasdfasdfsdfadf", "6", 5, "dfasdfasdfasdf", 2.3, 2.3, true));
