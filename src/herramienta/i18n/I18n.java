// AUTO-GENERAT per scripts/gen_strings.py — edita strings/strings.csv en lloc d'això
...
public class I18n {
    ...
    static {
        ...
        T("dlg_restore_done_with_note", "{0}\n\n{1}", "{0}\n\n{1}", "{0}\n\n{1}");
    ...
    public static String t(String key, Object... args) {
        ...
        if (args.length > 0) {
            // Comprova cada posició d'argument sol·licitada, no només
            // {0}, de manera que una clau amb `{1}` però sense `{0}`
            // també s'assenyala (veure el finding LOW de tot.txt). Fa
            // servir l'índex d'argument més alt com a sentinella — si
            // la plantilla té almenys aquest, les posicions anteriors
            // normalment també hi són.
    ...
    public static void aplicarSwingOptionPane() {
    ...
    private static int langIndex() {
        ...
        if (lang != null && !lang.isEmpty() && !"ca".equals(lang)) {
            // Codi d'idioma desconegut (p. ex. "fr") — registra un
            // avís i cau a ca en lloc de renderitzar silenciosament en
            // català (segons el finding LOW de tot.txt sobre langIndex).
